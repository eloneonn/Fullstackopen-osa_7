...
import { Route, Link, Routes, useNavigate, useMatch } from 'react-router-dom'
...
const Anecdote = ({ anecdote }) => {
  ...
  console.log('Viewing anecdote:', anecdote);
  return (
  <div>
...
const App = () => {
  ...
  const addNew = (anecdote) => {
    ...
    console.log('Added new anecdote:', anecdote);
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/anecdotes/:id' element={<Anecdote anecdote={anecdoteToShow}/>}/>
      </Routes>
      <Footer/>
    </div>
  )
